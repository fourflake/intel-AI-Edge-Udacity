...
def handle_car(output, input_shape):
    ...
    color_argmax = np.argmax(output['color'])
    color = output['color']
    color_flat = color.flatten()
    # TODO 2: Get the argmax of the "type" output
    type_argmax = np.argmax(output['type'])
    print('TEST----------type argmax')
    print(type_argmax)
    print('TEST----------color argmax')
    print(color_argmax)
    print('TEST----------color')
    print(color)
    print('TEST----------color flat')
    print(color_flat)
